...
Тема: Розробка клієнтської частини інтернет-магазину з використанням React
Мета проєкту: Створити сучасний вебзастосунок інтернет-магазину з адаптивним інтерфейсом, каталогом товарів, пошуком, фільтрацією, авторизацією, кошиком та оформленням замовлення.
